...
console.log(SubItemsList)
  ...
  useEffect(() => {
    ...
    if (productlists) {
      const products = productlists.find((product) => product.Id === parseInt(id, 10));
...
>
  ...
  <div className="flex items-center space-x-5">
    <label className="text-sm font-medium text-gray-700">Offer Product</label>
    <input
      type="checkbox"
      className="form-check-input"
  ...
  <div className="flex items-center space-x-8">
    <label className="text-sm font-medium text-gray-700">Top Product</label>
    <input
      type="checkbox"
      className="form-check-input"
